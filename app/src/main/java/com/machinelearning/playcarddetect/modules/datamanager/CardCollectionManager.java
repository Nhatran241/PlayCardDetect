...
//        return Card.Suit.NotDetect;
//    }
    public List<CardBase64> getCardsZoneBitmap(Context context, Bitmap baseBitmap , Rect zoneContainCardsZone, int patternCard, int patternZone){
        List<CardBase64> cardsInZone = new ArrayList<>();
        /**
...
//                suitType = Card.Suit.NotDetect;
                ...
                CardBase64 card = new CardBase64(ImageUtil.convert(cardBitmap),cardRect);
